...
open OUT2,">zscore.$TYPE.all.tsv";
open OUT3,">zscore.$TYPE.core.tsv";
open OUT4,">zscore.$TYPE.high.tsv";
...
print OUT3 "gene_id\t",join("\t",@header[4..$#header]),"\n";
print OUT4 "gene_id\t",join("\t",@header[4..$#header]),"\n";
my $total = 0;
my $up = 0;
my $down = 0;
my $substrate = 0;
